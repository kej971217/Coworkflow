                        ...
                        <div id="chats" class="tab-pane active" role="tabpanel" aria-labelledby="chats-tab">
                            ...
                            <div class="chat__chat-list overflow-y-auto scrollbar-hidden pr-1 pt-1 mt-4">
                                ...
                                <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                    ...
                                    <div class="w-5 h-5 flex items-center justify-center absolute top-0 right-0 text-xs text-white rounded-full bg-primary font-medium -mt-1 -mr-1">1</div>
                                </div>
                                <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                    <div class="w-12 h-12 flex-none image-fit mr-1">
                                        <img alt="Coworkflow" class="rounded-full" src="${cPath}/resources/Rubick/dist/images/profile-13.jpg">
                                ...
                                <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                    ...
                                    <div class="ml-2 overflow-hidden">
                                        <div class="flex items-center">
                                            <a href="javascript:;" class="font-medium">Nicolas Cage</a> 
                                            <div class="text-xs text-slate-400 ml-auto">06:05 AM</div>
                                        </div>
                                        <div class="w-full truncate text-slate-500 mt-0.5">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomi</div>
                                    </div>
                            ...
                            <div class="pr-1">
                                <div class="box px-5 py-10 mt-5">
                                    ...
                                    <div class="text-center mt-3">
                                        ...
                                        <div class="text-slate-500 mt-1"><security:authentication property="principal.realUser.empName" /></div>
                                    </div>
                        ...
                        <div class="hidden h-full flex flex-col">
                            ...
                            <div class="overflow-y-scroll scrollbar-hidden px-5 pt-5 flex-1">
                                ...
                                <div class="chat__box__text-box flex items-end float-left mb-4">
                                    ...
                                    <div class="bg-slate-100 dark:bg-darkmode-400 px-4 py-3 text-slate-500 rounded-r-md rounded-t-md">
                                        Arnold Schwarzenegger is typing 
