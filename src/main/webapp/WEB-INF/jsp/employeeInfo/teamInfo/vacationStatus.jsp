        ...
        <div class="content">
            ...
            <div class="intro-y box p-5 mt-5">
                <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                    <form id="teamVacationStatusTab-html-filter-form" class="xl:flex sm:mr-auto" >
                        <div class="sm:flex items-center sm:mr-4">
                            <label class="w-12 flex-none xl:w-auto xl:flex-initial mr-2">Field</label>
                            <select id="teamVacationStatusTab-html-filter-field" class="form-select w-full sm:w-32 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
                        ...
                        <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                            ...
                            <select id="teamVacationStatusTab-html-filter-type" class="form-select w-full mt-2 sm:mt-0 sm:w-auto" >
                        ...
                        <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                            ...
                            <input id="teamVacationStatusTab-html-filter-value" type="text" class="form-control sm:w-40 2xl:w-full mt-2 sm:mt-0" placeholder="Search..." autocomplete="off">
                        </div>
                        <div class="mt-2 xl:mt-0">
                            <button id="teamVacationStatusTab-html-filter-go" class="btn btn-primary w-full sm:w-16" >Go</button>
                            <button id="teamVacationStatusTab-html-filter-reset" class="btn btn-secondary w-full sm:w-16 mt-2 sm:mt-0 sm:ml-1" >Reset</button>
                        </div>
                    </form>
                    <div class="flex mt-5 sm:mt-0">
                        <button id="teamVacationStatusTab-print" class="btn btn-outline-secondary w-1/2 sm:w-auto mr-2"> <i icon-name="printer" class="w-4 h-4 mr-2"></i> Print </button>
                        <div class="dropdown w-1/2 sm:w-auto">
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        <a id="teamVacationStatusTab-export-csv" href="javascript:;" class="dropdown-item"> <i icon-name="file-text" class="w-4 h-4 mr-2"></i> Export CSV </a>
                                    </li>
                                    <li>
                                        <a id="teamVacationStatusTab-export-json" href="javascript:;" class="dropdown-item"> <i icon-name="file-text" class="w-4 h-4 mr-2"></i> Export JSON </a>
                                    </li>
                                    <li>
                                        <a id="teamVacationStatusTab-export-xlsx" href="javascript:;" class="dropdown-item"> <i icon-name="file-text" class="w-4 h-4 mr-2"></i> Export XLSX </a>
                                    </li>
                                    <li>
                                        <a id="teamVacationStatusTab-export-html" href="javascript:;" class="dropdown-item"> <i icon-name="file-text" class="w-4 h-4 mr-2"></i> Export HTML </a>
                                    </li> 
                                </ul>
                            </div>
                        </div>
                ...
                <div class="overflow-x-auto scrollbar-hidden">
                    <div id="teamVacationStatusTab" class="mt-5 table-report table-report--tabulator"></div>
                </div>
            </div>
            <!-- END: HTML Table Data -->
...
$(function(){
	...
	var fieldEl = document.getElementById("teamVacationStatusTab-html-filter-field");
	var typeEl = document.getElementById("teamVacationStatusTab-html-filter-type");
	var valueEl = document.getElementById("teamVacationStatusTab-html-filter-value");
	...
	document.getElementById("teamVacationStatusTab-html-filter-field").addEventListener("change", updateFilter);
	document.getElementById("teamVacationStatusTab-html-filter-type").addEventListener("change", updateFilter);
	document.getElementById("teamVacationStatusTab-html-filter-value").addEventListener("keyup", updateFilter);
	
	
	
	//Clear filters on "Clear Filters" button click
	document.getElementById("teamVacationStatusTab-html-filter-reset").addEventListener("click", function(){
		fieldEl.value = "";
		typeEl.value = "=";
		valueEl.value = "";
	...
	//Build Tabulator
	var table = new Tabulator("#teamVacationStatusTab", {
		ajaxURL: "${cPath}/employeeInfo/teamInfo/selectTeamVacationList.do",
...
// 			console.log(response);
	...
	document.getElementById("teamVacationStatusTab-export-csv").addEventListener("click", function(){
	    table.download("csv", "data.csv");
	});

	//trigger download of data.json file
	document.getElementById("teamVacationStatusTab-export-json").addEventListener("click", function(){
	    table.download("json", "data.json");
	});

	//trigger download of data.xlsx file
	document.getElementById("teamVacationStatusTab-export-xlsx").addEventListener("click", function(){
	    table.download("xlsx", "data.xlsx", {sheetName:"My Data"});
	});

	//trigger download of data.pdf file
	document.getElementById("teamVacationStatusTab-print").addEventListener("click", function(){
	...
	document.getElementById("teamVacationStatusTab-export-html").addEventListener("click", function(){
