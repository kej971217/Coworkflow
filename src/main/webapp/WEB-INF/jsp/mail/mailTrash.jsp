...
<div class="grid grid-cols-12 gap-6 mt-8">
    <div class="col-span-12 lg:col-span-3 2xl:col-span-2">
        <h2 class="intro-y text-lg font-medium mr-auto mt-2">
            <spring:message code="level2Menu.mailTrash"/>
        </h2>
            ...
            <div class="intro-y inbox box mt-10">
                <div
                    ...
                    <div
                        ...
                        <!--  ----------------   메일 새로 고침 --------------  -->
                        <a href="${cPath}/mail/mailTrash/mailTrashOpen.do"
...
<div id="dataPrintArea" style="display: block">
        ...
        if (dataList != null && dataList.length > 0) {
            ...
            for (let i = startRow; i <= endRow; i++) {
                if (dataList.hasOwnProperty(i)) {
                    ...
                    raw1num.setAttribute("class", "inbox__item inbox__item--active inline-block sm:block text-slate-600 dark:text-slate-500 bg-slate-100 dark:bg-darkmode-400/70 border-b border-slate-200/60 dark:border-darkmode-400");
                    ...
                    var dDateTime = new Date(dataDate['year'], dataDate['month'], dataDate['day'], dataTime['hour'], dataTime['minute'], dataTime['second']);
                    ...
                    var day = (dDateTime.getDate() + 1).toString().padStart(2, '0');
                    var hour = (dDateTime.getHours() + 1).toString().padStart(2, '0');
                    var min = (dDateTime.getMinutes() + 1).toString().padStart(2, '0');
            ...
            var noNode = document.createTextNode("휴지통 메일이 없습니다.");
