    ...
    <div class="grid grid-cols-12 gap-6 mt-8">
        <div class="col-span-12 lg:col-span-3 2xl:col-span-2">
            <h2 class="intro-y text-lg font-medium mr-auto mt-2">
                <spring:message code="level2Menu.mailSent"/>
            </h2>
            <%-- 메일 좌측 사이드 메뉴 include --%>
            <jsp:include page="/includee/mailLeftMenu.jsp"></jsp:include>
        </div>
        <%--  받은 편지함 본문 --%>
        <div class="col-span-12 lg:col-span-9 2xl:col-span-10 mt-10 pt-5">
            <!-- BEGIN: Inbox Filter -->
            ...
            <div class="intro-y inbox box">
                <div
                    ...
                    <div
                        ...
                        <!--  ----------------   메일 새로 고침 --------------  -->
                        <a href="${cPath}/mail/mailSent/sentOpen.do"
...
<script>
    ...
    if (serverValue != null && serverValue != "") {
        ...
        if (dataList != null && dataList.length > 0) {
            ...
            for (let i = startRow; i <= endRow; i++) {
                if (dataList.hasOwnProperty(i)) {
                    ...
                    if (mailSendSender != null && mailSendSender) {
                        var fNNode = document.createTextNode("나");
            ...
            var noNode = document.createTextNode("보낸 메일이 없습니다.");
        ...
        function fn_paging(pageNumber, event) {
            ...
            location.href = `${cPath}/mail/mailSent/choicePage.do?page=` + pageNumber;
        }
        ...
        var clickedRow = e.target.closest("#mailListIndex");*/
            ...
            location.href = "${cPath}/mail/mailSent/choiceMail.do?what=" + mailId;
