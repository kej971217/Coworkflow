...
<div class="grid grid-cols-12 gap-6 mt-8">
    <div class="col-span-12 lg:col-span-3 2xl:col-span-2">
        <h2 class="intro-y text-lg font-medium mr-auto mt-2">
            <spring:message code="level2Menu.mailStar"/>
        </h2>
        <!-- BEGIN: Inbox Menu -->
        <div id="sideMenu">
    ...
    <div class="col-span-12 lg:col-span-9 2xl:col-span-10">
        ...
        <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
            ...
            <div class="w-full sm:w-auto flex">
                <button class="btn btn-primary shadow-md mr-2"><spring:message code="level2Menu.mailDelete"/> </button>
            </div>
        </div>
        <!-- END: Inbox Filter -->
        <!-- BEGIN: Inbox Content -->
                            ...
                            <div class="w-72 flex-none flex items-center mr-5">
                                ...
                                <a href="javascript:;"
                                   class="w-5 h-5 flex-none ml-4 flex items-center justify-center text-slate-400">
                                    <i class="w-4 h-4" icon-name="star"></i> </a>
