...
<div class="content">
            <!-- BEGIN: Profile Info -->
            <div class="intro-y box px-5 pt-5 mt-10">
                <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                    <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                        <div class="rounded-full w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                            <c:if test="${not empty mypage.profileImage}" >
								<img id="faciImg" class="rounded-full" alt="${mypage.profileImage.empAtchOriginName}" src="${cPath }/mypage/${mypage.profileImage.empAtchSaveName}"/>
							</c:if>
                        ...
                        <div class="ml-5">
                            <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg"><a href="${cPath}/mypage/mypageEditView.do">${mypage.empName }</a></div>
                            <div class="text-slate-500">${mypage.teamName }_${mypage.positionName }</div>
                        </div>
                    </div>
                    <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                        <div class="font-medium text-center lg:text-left lg:mt-3">연락처</div>
                        <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                            <div class="truncate sm:whitespace-normal flex items-center"> <i icon-name="mail" class="w-4 h-4 mr-2"></i> ${mypage.infoEmail }</div>
                            <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i icon-name="instagram" class="w-4 h-4 mr-2"></i> ${mypage.comTel } </div>
                            <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i icon-name="twitter" class="w-4 h-4 mr-2"></i> ${mypage.infoHp } </div>
                        </div>
                    </div>
                ...
                <ul class="nav nav-link-tabs flex-col sm:flex-row justify-center lg:justify-start text-center" role="tablist" >
                    <li id="profile-tab" class="nav-item" role="presentation">
                        <a href="${cPath}/mypage/mypageEditView.do" class="nav-link py-4 flex items-center active" data-tw-target="#profile" aria-controls="profile" aria-selected="true" role="tab" > <i class="w-4 h-4 mr-2" icon-name="user"></i> 개인정보 수정 </a>
                    </li>
                    <li id="change-password-tab" class="nav-item" role="presentation">
                        <a href="${cPath}/mypage/passChange.do" class="nav-link py-4 flex items-center" data-tw-target="#change-password" aria-selected="false" role="tab" > <i class="w-4 h-4 mr-2" icon-name="lock"></i> 비밀번호변경 </a>
                    </li>
                    <li id="settings-tab" class="nav-item" role="presentation">
                        <a href="${cPath}/mypage/atrzSetting.do" class="nav-link py-4 flex items-center" data-tw-target="#settings" aria-selected="false" role="tab" > <i class="w-4 h-4 mr-2" icon-name="settings"></i> 결재설정 </a>
                    </li>
                </ul>
            </div> 
            <!-- END: Profile Info -->
                        ...
                        <div class="intro-y box col-span-12 lg:col-span-6">
                            ...
                            <div class="p-5">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <a class="font-medium" href="">2109_공공데이터 공통표준단어 용어 도메인_목록(엑셀버전).xlsx</a> 
