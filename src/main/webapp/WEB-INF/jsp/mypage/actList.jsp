                ...
                <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                    <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                        <div class="w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                            ...
                            <div class="absolute mb-1 mr-1 flex items-center justify-center bottom-0 right-0 bg-primary rounded-full p-2"> <i class="w-4 h-4 text-white" icon-name="camera"></i> </div>
                        </div>
                        <div class="ml-5">
                            <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg">Kate Winslet</div>
                    ...
                    <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                        ...
                        <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                            <div class="truncate sm:whitespace-normal flex items-center"> <i icon-name="mail" class="w-4 h-4 mr-2"></i> katewinslet@left4code.com </div>
                            <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i icon-name="instagram" class="w-4 h-4 mr-2"></i> Instagram Kate Winslet </div>
                            <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i icon-name="twitter" class="w-4 h-4 mr-2"></i> Twitter Kate Winslet </div>
                        </div>
                    </div>
                                ...
                                <div class="dropdown ml-auto">
                                    ...
                                    <div class="dropdown-menu w-40">
                                        <ul class="dropdown-content">
                                            <li>
                                                <a href="" class="dropdown-item"> <i icon-name="plus" class="w-4 h-4 mr-2"></i> Add Category </a>
                                            </li>
                                            <li>
                            ...
                            <div class="flex items-center px-5 py-5 sm:py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                                ...
                                <div class="dropdown ml-auto sm:hidden">
                                    ...
                                    <div class="dropdown-menu w-40">
                                        <ul class="dropdown-content">
                                            <li>
                                                <a href="javascript:;" class="dropdown-item"> <i icon-name="file" class="w-4 h-4 mr-2"></i> Download Excel </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <button class="btn btn-outline-secondary hidden sm:flex"> <i icon-name="file" class="w-4 h-4 mr-2"></i> Download Excel </button>
                            </div>
                            <div class="p-5">
                                ...
                                <div class="relative flex items-center mt-5">
                                    <div class="w-12 h-12 flex-none image-fit">
                                        <img alt="Coworkflow" class="rounded-full" src="${cPath}/resources/Rubick/dist/images/profile-6.jpg">
                                    </div>
                                    <div class="ml-4 mr-auto">
                            ...
                            <div class="flex items-center px-5 py-5 sm:py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                                ...
                                <div class="dropdown ml-auto sm:hidden">
                                    ...
                                    <div class="dropdown-menu w-40">
                                        <ul class="dropdown-content">
                                            <li>
                                                <a href="javascript:;" class="dropdown-item"> <i icon-name="file" class="w-4 h-4 mr-2"></i> Download XML </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <button class="btn btn-outline-secondary hidden sm:flex"> <i icon-name="file" class="w-4 h-4 mr-2"></i> Download XML </button>
                            </div>
