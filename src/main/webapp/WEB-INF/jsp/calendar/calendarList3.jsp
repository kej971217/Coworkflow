            ...
            <div class="grid grid-cols-12 gap-5 mt-5">
                ...
                <div class="col-span-12 xl:col-span-4 2xl:col-span-3">
                    <div class="box p-5 intro-y">  
                        ...
                        <a id="addSchedule" href="javascript:;" data-tw-toggle="modal" data-tw-target="#scheduleModal" class="btn btn-primary w-full mt-2"> <i class="w-4 h-4 mr-2" icon-name="edit-3"></i> 일정 등록 Add New Schedule </a>
...
<div id="programmatically-modal" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	<a id="programmatically-hide-modal" href="javascript:;" onclick="colorCalendarModal.hide();" class="btn btn-primary mr-1">닫기</a>
            </div>  
        </div>
    </div>
</div>
