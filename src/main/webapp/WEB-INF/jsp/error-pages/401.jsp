        ...
        <div class="container">
            ...
            <div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
                ...
                <div class="text-white mt-10 lg:mt-0">
                    <div class="intro-x text-8xl font-medium">401</div>
                    <div class="intro-x text-xl lg:text-3xl font-medium mt-5">Unauthorized</div>
                    <div class="intro-x text-lg mt-3">인증 정보가 없습니다. 로그인 해주세요.</div>
