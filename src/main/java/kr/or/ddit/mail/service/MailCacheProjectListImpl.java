...
@Slf4j
@Service
public class MailCacheProjectListImpl implements MailCacheProjectList{

    @Inject
    private final MailCacheInfoAboutTeamResolver mailCacheInfoAboutTeamResolver;

    public MailCacheProjectListImpl(MailCacheInfoAboutTeamResolver mailCacheInfoAboutTeamResolver) {
