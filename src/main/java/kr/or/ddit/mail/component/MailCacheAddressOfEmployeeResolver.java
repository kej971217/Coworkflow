...
@Component
public class MailCacheAddressOfEmployeeResolver implements CacheResolver {
    private final CacheManager cacheManager;

    public MailCacheAddressOfEmployeeResolver(CacheManager cacheManager) {
    ...
    public Collection<? extends Cache> resolveCaches(CacheOperationInvocationContext<?> context) {
        Cache mailAddressCache = cacheManager.getCache("mailAddressOfEmployee");
