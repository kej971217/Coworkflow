...
@Component
public class MailCacheEmployeeListResolver implements CacheResolver {
    private final CacheManager cacheManager;

    public MailCacheEmployeeListResolver(CacheManager cacheManager) {
    ...
    public Collection<? extends Cache> resolveCaches(CacheOperationInvocationContext<?> context) {
        Cache mailAddressCache = cacheManager.getCache("mailEmployeeList");
